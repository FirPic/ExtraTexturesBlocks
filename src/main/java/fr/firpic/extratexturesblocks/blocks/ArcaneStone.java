...
public class ArcaneStone {
    ...
    public static final RegistryObject<Block> ARCANE_STONE_JELLYBEAN= registerBlock("arcane_stone_jellybean",
        ()-> new Block(AbstractBlock.Properties.create(Material.ROCK)
            .harvestLevel(2)
            .harvestTool(ToolType.PICKAXE)
            .setRequiresTool()
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block){
        EtbItemsRegistry.ITEMS.register(name, ()->new BlockItem(block.get(),
                new Item.Properties().group(EtbItemGroup.Arcane_StoneGroup)));
    }
