...
def json_blockstates_model_loot_tables():
    ...
    for x in range(len(list_of_blocks)):
        ...
        #file_data_loot_tables = open("..\\src\\main\\resources\\data\\extratexturesblocks\\loot_tables\\blocks\\"+file ,"w+")
        ...
        json_name(block_name)


def json_name(blockName):
    ...
    lang_en_us = open('..\\src\\main\\resources\\assets\\extratexturesblocks\\lang\\en_us.json', "w")
    print(JSONdata)
